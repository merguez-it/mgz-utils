#ifndef __ZIP_COMPRESS_H
#define __ZIP_COMPRESS_H
...
public:
  ...
  void add_file(Glow::Util::file &fileToAdd, const Glow::Util::file &base_dir);  
  
  compress(const Glow::Util::file &archive, unsigned short compression_method=CM_DEFLAT, int level=Glow::Command::COMPRESSION_LEVEL_4);
...
private:
  ...
  central_directory_header header_from_file(Glow::Util::file& fileToAdd, const Glow::Util::file& base_dir);
